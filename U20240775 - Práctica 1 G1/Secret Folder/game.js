var Snake = (function () {
  ...
  var game = {
    reset: function () {
      ctx.fillStyle = 'grey'; //La pantalla de recargar el juego, pasa rapido apenas se nota pero se ve bien.
    ...
    loop: function () {
      ...
      ctx.fillText("points: " + points, 288, 30);
      ctx.fillText("top: " + pointsMax, 288, 50);
...
Snake.start(10); //Estos serian los fps a los que funciona el juego.
Snake.setup.keyboard(true);
Snake.setup.fixedTail(false); //Esto de aqui sirve para que la culicha se agrande.
                              //Si esta en true, no se hara mas grande con cada fruta que coma.
